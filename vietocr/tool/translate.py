...
from MangaOCR.vietocr.model.transformerocr import VietOCR
from MangaOCR.vietocr.model.vocab import Vocab
from MangaOCR.vietocr.model.beam import Beam
...
def build_model(config):
    # change vocab to Japanese vocabulary
