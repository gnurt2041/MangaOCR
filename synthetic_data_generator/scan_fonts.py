...
# ASSETS_PATH = Path('../assets').expanduser()
ASSETS_PATH = Path('/teamspace/studios/this_studio/manga-ocr/assets')
# FONTS_ROOT = Path('./data/font/static').expanduser()
FONTS_ROOT = Path('/teamspace/studios/this_studio/manga-ocr/assets/font/static')
# print(ASSETS_PATH,FONTS_ROOT)
...
def main():
    ...
    data['num_chars'] = len(str(data.supported_chars))
    data['label'] = 'regular'
